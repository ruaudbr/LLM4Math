...
RUN python3 -m pip --no-cache-dir install --upgrade pip \
    ...
    && python3 -m pip --no-cache-dir install bitsandbytes \
    && python3 -m pip --no-cache-dir install git+https://github.com/huggingface/transformers.git \
    && python3 -m pip --no-cache-dir install optimum \
    && python3 -m pip --no-cache-dir install git+https://github.com/huggingface/accelerate.git \
    && python3 -m pip --no-cache-dir install huggingface-hub
